...
export const engineGuides = [
  {name: 'Prot Core Engine v0.0', detail: 'Sáu nhóm: nền phẳng, cờ tăng/pennant, hai đáy, hai đỉnh, vai đầu vai/ngược, cốc tay cầm/đáy tròn. Cốc và đáy tròn là một nhóm cấu trúc, không tạo hai phiếu. Cốc ưu tiên khung Tuần; breakout phải vượt miệng cốc với volume. Mỗi biểu đồ chỉ chọn cấu trúc mạnh nhất trước khi qua bộ lọc chung.'},
