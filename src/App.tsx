...
function ExecutiveKpiStrip({ signalCount, highConfluenceCount, universeCount, connectionLabel, health }: { signalCount: number; highConfluenceCount: number; universeCount: number; connectionLabel: string; health?: { latest_price_date: string | null; failed_jobs_7d: number } }) {
